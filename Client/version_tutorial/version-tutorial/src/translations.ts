...
const spanishMessages: TranslationMessages = {
    ra: {
        ...
        message: {
            ...
            bulk_delete_content: '¿Estás seguro de que deseas eliminar este %{name}? |||| ¿Estás seguro de que deseas eliminar estos %{smart_count} elementos?',
            bulk_delete_title: 'Eliminar %{name} |||| Eliminar %{smart_count} %{name}',
            bulk_update_content: '¿Estás seguro de que deseas actualizar este %{name}? |||| ¿Estás seguro de que deseas actualizar estos %{smart_count} elementos?',
            bulk_update_title: 'Actualizar %{name} |||| Actualizar %{smart_count} %{name}',
            clear_array_input: '¿Estás seguro de que deseas limpiar toda la lista?',
            delete_content: '¿Estás seguro de que deseas eliminar este elemento?',
            delete_title: 'Eliminar %{name} #%{id}',
            details: 'Detalles',
            error: 'Ocurrió un error del cliente y no se pudo completar tu solicitud.',
            invalid_form: 'El formulario no es válido. Por favor, revisa los errores',
            loading: 'Por favor espera',
            no: 'No',
            not_found: 'O escribiste una URL incorrecta, o seguiste un enlace incorrecto.',
            yes: 'Sí',
            unsaved_changes: 'Algunos de tus cambios no se guardaron. ¿Estás seguro de que deseas ignorarlos?',
        },
        navigation: {
            clear_filters: 'Limpiar filtros',
            no_filtered_results: 'No se encontraron %{resource} usando los filtros actuales.',
            no_results: 'No se encontraron %{resource}',
            no_more_results: 'El número de página %{page} está fuera de los límites. Intenta la página anterior.',
        ...
        saved_queries: {
            ...
            remove_message: '¿Estás seguro de que deseas eliminar ese elemento de tu lista de consultas guardadas?',
